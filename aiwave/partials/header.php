                        ...
                        <div class="col-lg-3 col-md-6 col-6">
                            <div class="header-left d-flex">
                                <div class="expand-btn-grp">
                                    <button class="bg-solid-primary popup-dashboardleft-btn"><i class="fa-sharp fa-regular fa-sidebar"></i></button>
                                </div>
                                <div class="logo">
                                    <a href="index.php">
                            ...
                            <nav class="mainmenu-nav d-none d-lg-inline-block text-center">
                                <ul class="mainmenu">
                                    ...
                                    <li class="has-dropdown has-menu-child-item position-relative"><a href="#">Tools <i class="fa-regular fa-chevron-down"></i></a>
                                        <ul class="submenu">
                                            <li>
                                                <a href="text-generator.php">
                                                    <span>Text Generator</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="image-generator.php">
                                                    <span>Image Generator</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="code-generator.php">
                                                    <span>Code Generator</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="image-editor.php">
                                                    <span>Image Editor</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="video-generator.php">
                                                    <span>Video Generator</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="email-generator.php">
                                                ...
                                                <div class="row row--0">
                                                    ...
                                                    <div class="col-lg-3 single-mega-item">
                                                        <ul class="mega-menu-item br--0">
                                                            ...
                                                            <li>
                                                                <a href="#" class="disabled">
                                                                    <span>Youtube Video to Post</span>
                                    ...
                                    <li><a href="utilize.php">How to use</a></li>
                                </ul>
                                    ...
                                    <div class="rbt-admin-card grid-style">
                                        <a class="d-flex align-items-center" href="#">
                                            <div class="inner d-flex align-items-center">
                                                <div class="img-box">
                                                    <img src="assets/images/team/team-01sm.jpg" alt="Admin">
                                                </div>
                                                <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="rbt-admin-profile">
                                                <div class="admin-thumbnail">
                                                    <img src="assets/images/team/team-01sm.jpg" alt="User Images">
                                                </div>
